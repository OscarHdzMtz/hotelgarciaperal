<x-forms-layout>
    <div class="w-full {{-- px-9  --}}{{-- py-8 --}} mx-auto {{-- sm:px-6 --}} lg:px-72 max-w-9xl">
        ...
        <div class="w-full px-3 pt-3 mx-auto {{-- bg-gray-300 --}} bg-blue-950 lg:px-10">
        ...
        <div class="container mx-auto mb-2">
            <div class="grid grid-cols-1 mx-auto">                
                <img {{-- style="margin-top: -30px" --}} class="mx-auto" src="{{ asset('img/Gperal.png') }}" alt="logoGarciaPeral" width="550px" height="550px" />
                ...
                <div class="grid grid-cols-1 md:mt-0 md:grid-cols-2">

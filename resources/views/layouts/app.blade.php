...
<body class="antialiased font-inter bg-slate-100 text-slate-600" :class="{ 'sidebar-expanded': sidebarExpanded }"
    ...
    {{-- Guarda los valores del componente de la pregunta (respuestas de las preguntas) al local Storage --}}
    <script src="{{ asset('js/dashboard/preguntasFormulario/guardarComponnteAlocalStorage.js') }}"></script>

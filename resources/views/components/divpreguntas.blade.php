<div class="mt-5">
    @foreach ($allPreguntas as $item)
        <div class="container px-4 mx-auto mt-5 rounded bg-slate-100">
                    ...
                    <div class="w-full mb-10 md:w-1/2 md:mb-0">
                        ...
                        @elseif ($item->tipodecomponente == 'radio')
                            <div class="mx-5">
                                ...
                                @endphp
                                <x-jet-label>
                                    <strong>TIPO DE RESPUESTA PARA LA PREGUNTA {{ $valorcomponenteArray[0] }}</strong>
                                </x-jet-label>
                                <div>
            ...
            {{-- <div style="margin-bottom: 10px" class="px-4 py-1 mx-auto mt-5 mb-10 bg-indigo-300 rounded">

<x-app-layout>
    <div class="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl">
        ...
        <div class="mb-8 sm:flex sm:justify-between sm:items-center">
            ...
            <div class="grid justify-start grid-flow-col gap-2 sm:auto-cols-max sm:justify-end">
                ...
                <button class="text-white bg-indigo-500 btn hover:bg-indigo-600">
                    ...
                    <span class="hidden ml-2 xs:block">Agragar modulo</span>
                </button>
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <x-dashboard.dashboard-card-01 :dataFeed="$totalDePreguntas" titulo="Total de preguntas"/>

            <!-- Line chart (Acme Advanced) -->
            <x-dashboard.dashboard-card-02 :dataFeed="$totalDeRespuestasFinalizadas"  titulo="Total de respuestas finalizadas" />

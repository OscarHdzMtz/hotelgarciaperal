    ...
    <div class="flex items-center pt-4">
            ...
            <div>
                @for ($radio = 0; $radio < $preguntas->numerodecomponente; $radio++)
                    <div
                        ...
                        <label class="mt-px font-light text-gray-700 cursor-pointer select-none text-blue-gray-700 " for="html">
        ...
        @elseif($preguntas->tipodecomponente === 'select')
            <div class="relative h-10 w-72 min-w-[200px]">
                <select
                    class="block w-full px-4 py-3 text-sm border-green-500 rounded-md pr-9 focus:border-green-600 focus:ring-green-500 "
                    required>

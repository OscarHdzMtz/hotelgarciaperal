<div class="px-5 py-5 mb-5 ml-3 mr-3 bg-indigo-100 rounded">
    <a
        class="block text-lg font-semibold transition-colors font-body text-primary hover:text-green dark:text-black dark:hover:text-secondary">{{ $preguntas->pregunta }} <small class="text-lg text-red-600">{{ $preguntas->campoobligatorio == 1 ? "*": "" }}</small></a>
        ...
        @if ($preguntas->tipodecomponente === 'input')
            <div class="relative h-10 w-full min-w-[200px]">
                {{-- <input
                    ...
                    placeholder=" " {{ $preguntas->campoobligatorio == 1 ? 'required' : '' }}
                ...
                <input type="{{ $preguntas->tipodedatos }}" {{ $preguntas->mindecaracteres  > 0 ? 'minlength=' . $preguntas->mindecaracteres . " " : "" }} {{ $preguntas->mindecaracteres  > 0 ? 'maxlength=' . $preguntas->mindecaracteres . " " : "" }}   class="bg-green-50 border border-green-500 text-green-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-white dark:border-green-500" placeholder="Ingrese su respuesta" {{ $preguntas->campoobligatorio == 1 ? 'required' : '' }} wire:model='valoresRespuesta'>
            </div>
